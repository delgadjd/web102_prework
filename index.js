...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `${game.name} <br /> ${game.description} <br /> Backers: ${game.backers} <br /> <img src=${game.img} class="game-img" />`;
...
unfundedElement.innerHTML = `We have currently raised $${totalRaised.toLocaleString()} for ${numGames} games. There ${unfundedString} that have not yet met their goal.`;
